...
public class SignupEmailTemplate {
    public static String signup(String firstName, String token){
        String link = "http://localhost:8080/auth/email-confirmation/"+token;
